...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <style>
    .bg-menu-theme {
    background-color:rgb(247, 222, 244) !important;
    }
  ...
  .bg-menu-theme .menu-inner > .menu-item.active > .menu-link {
    color: #566a7f;
    background-color: rgb(233 73 230 / 9%) !important;
  }
    </style>

  <body>
    <!-- Layout wrapper -->
    <div id="master" class="layout-wrapper layout-content-navbar">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">LUNED'S CROCHET</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Components -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">MAS VISTAS</span></li>
            <!-- Cards -->
            <li class="menu-item">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">EVA LEON</span>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , HECHO ❤️ POR
                  <a href="#" target="_blank" class="footer-link fw-bolder">JEV LEON</a>
                </div>
                <div>
